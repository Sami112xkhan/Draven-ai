...
import com.samikhan.draven.data.model.Task;
...
public final class TaskDao_Impl implements TaskDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfUpdateTaskCompleted;
  ...
  public TaskDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `tasks` (`id`,`title`,`description`,`completed`,`timestamp`) VALUES (?,?,?,?,?)";
      }
    ...
    this.__preparedStmtOfUpdateTaskCompleted = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
  ...
  @Override
  public Object updateTaskCompleted(final String taskId, final boolean completed,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateTaskCompleted.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __db.endTransaction();
          __preparedStmtOfUpdateTaskCompleted.release(_stmt);
        }
      }
    }, $completion);
  }
      ...
      public List<Task> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new Task(_tmpId,_tmpTitle,_tmpDescription,_tmpCompleted,_tmpTimestamp);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Task call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            final long _tmpTimestamp;
            _tmpTimestamp = _cursor.getLong(_cursorIndexOfTimestamp);
            _result = new Task(_tmpId,_tmpTitle,_tmpDescription,_tmpCompleted,_tmpTimestamp);
          } else {
            _result = null;
          }
          return _result;
